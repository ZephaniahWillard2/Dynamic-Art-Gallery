...
function App() {
  ...
  const moveArtworkToFeatured = () =>{
    onclick(moveArtworkToFeatured(artwork))
  }
  ...
  return (
    <div>
      ...
      <div style={{height:'400px', borderBottom:'solid #b70132 10px'}}>
        ...
        <FeaturedArtSection featuredArtworks={featuredArtworks} moveArtworkToFeatured={moveArtworkToFeatured}></FeaturedArtSection>
      </div>
